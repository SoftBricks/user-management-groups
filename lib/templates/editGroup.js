UM.prototype.umEditGroupHelpers = {
    ...
    users: function(){
        if( typeof Groups.findOne({_id:this._id}) !== 'undefined'){
          return Groups.findOne({_id:this._id}).users;
        }
...
UM.prototype.umEditGroupEvents = {
    ...
    'click .userGroupRoles': function(e){
        Router.go('/editGroup/'+FlowRouter.getParam("groupId")+'/addUserToGroupRole/' + this.id);
    }
};
